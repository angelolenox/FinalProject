    ...
    <div class="container-fluid">
        <div class="row my-5 ">
            <div class="col-12 text-center">
                <h1 class="display-1 text-mybrown h1-media">Tutti gli articoli per: {{$query}}</h1>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-10 col-md-3 mt-5 mx-1 card-style">
                <div class="card-height">
                    <div>
                        <img class="img-style" src="{{Storage::url($article->image)}}" alt="card image">
                    </div>
                    <div class="">
                    ...
                    <div class="footer-card d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{route('article.show',compact('article'))}}" class="btn-welcome my-3 ">Leggi</a>
