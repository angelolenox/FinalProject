<x-layout>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center my-5">
            <h1 class="display-1 text-center text-mybrown h1-media">Dashboard <span class="text-myblu">Redattore</span></h1>
        </div>
    </div>
    @if(session('message'))
    ...
    <div class="container admin-tab">
        <div class="row my-5">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h5 class="text-myblu">Articoli in fase di revisione</h5>
